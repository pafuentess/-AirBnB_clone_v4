$(document).ready(function () {
  ...
  $('input[type="checkbox"]').click(function () {
    ...
    const H4a = $(this).closest('.amenities').find('h4');
    const list1 = [];
  ...
  $('.locations input[type="checkbox"]').click(function () {
    if ($(this).prop('checked') === true) {
      console.log(cities);
      cities[$(this).data('name')] = $(this).data('id');
    } else if ($(this).prop('checked') === false) {
      delete cities[$(this).data('name')];
    }
    console.log(cities);
    const H4b = $(this).closest('.locations').find('h4');
    const listCities = [];
    for (const i in cities) {
      listCities.push(i);
      // console.log(i);
      idCity.push(cities[i]);
    }
